			...
			<div className="container">
				<div className="grid xl:grid-cols-5 gap-6 py-12">
					<div className="xl:col-span-2">
						...
						Stop juggling multiple tools for your business. Revenue Roots helps you boost profits, save time, and unlock new opportunities — all in one place.
						</p>
					</div>
					...
					<div className="grid sm:grid-cols-2 text-center sm:text-start gap-6">
						<div>
							<p className="text-gray-500/80 text-sm">
								{new Date().getFullYear()}© Revenue Roots. All rights reserved.
								Crafted by{' '}
								<Link
									to=""
