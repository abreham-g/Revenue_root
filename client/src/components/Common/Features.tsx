					...
					<div className="container">
						<div className="text-center">
							...
							<h1 className="text-3xl/tight font-medium mt-3 mb-4">
								Better Arbitrage products, Better Profit
							</h1>
							<p className="text-gray-500">
								Start Sourcing with <span className="text-primary">Revenue Roots</span>{' '}
								to View the best Arbitrage products
							</p>
						</div>
									...
									>
										...
										>
											...
											<FUCollapse.Menu className="w-full overflow-hidden duration-300 ps-16">
												...
												Find products you can buy and resell at a higher price on Amazon for a profit.
												</p>
										...
										>
											...
											<FUCollapse.Menu className="w-full overflow-hidden duration-300 ps-16">
												<p className="text-gray-700 dark:text-gray-300">
													Import your wholesale lists with just one click and instantly see the top performers. 
													Say goodbye to tedious manual work—everything is fully automated.
												</p>
												<div className="mt-7 flex items-center">
													<Link to="" className="text-primary">
														Learn more{' '}
										...
										>
											...
											<FUCollapse.Menu className="w-full overflow-hidden duration-300 ps-16">
												<p className="text-gray-700 dark:text-gray-300">
												    Get instant insights into how a product performs across multiple regions.
												</p>
												<div className="mt-7 flex items-center">
													<Link to="" className="text-primary">
														Learn more{' '}
