// types
import { PlanItem, Benefit } from './types'
...
const benefits: Benefit[] = [
    ...
    description: 'Our dedicated technical support team is available 24/7 to resolve your issues quickly.'
  },
	{
		icon: (
			<svg
    ...
    description: 'Our experts guide you through setting up your Amazon seller account efficiently.'
  },
	{
		icon: (
			<svg
		...
		description: 'Our smart inventory tool ensures you never run out of stock or overstock your items.'
	  },
	{
		icon: (
			<svg
    ...
    description: 'Get expert recommendations for product titles, descriptions, and keywords to maximize sales.'
  },
  {
	icon: (
		<svg
    ...
    description: 'Understand your sales margins, expenses, and net profit with accurate insights.'
  },
{
	icon: (
		<svg
    ...
    description: 'Our system provides automated email follow-ups, reviews requests, and feedback management.'
  },
  {
	icon: (
		<svg
    ...
    description: 'Receive instant alerts about listing issues, pricing errors, or policy violations to keep your store compliant.'
  },
  {
	icon: (
		<svg
    ...
    description: 'Get AI-driven forecasts to predict sales trends and optimize your inventory levels.'
  },
]
