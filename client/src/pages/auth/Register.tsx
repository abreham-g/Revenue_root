    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                />
                <h3 style={{ fontWeight: 'bold', marginBottom: '1rem' }}>Create an account</h3>
                <p style={{ marginBottom: '1.5rem' }}>Sign up to access the admin panel.</p>
                ...
                <form>
                    ...
                    <input type="password" placeholder="Confirm Password" required style={{
                        width: '100%',
                        padding: '0.8rem',
                        margin: '0.5rem 0',
                        border: '1px solid #ccc',
                ...
                <div style={{ marginTop: '1rem' }}>
                    <p>Already have an account? <Link to="/login" style={{ color: '#4CAF50', fontWeight: 'bold' }}>Login</Link></p>
                </div>
            </div>
        </div>
    );
